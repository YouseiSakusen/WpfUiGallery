...
using MaterialDesignControls.Menus;
using Prism.Regions;
...
namespace MaterialDesignControls
{
	...
	public class MainWindowViewModel : HalationGhostViewModelBase
	{
		...
		private void initialilzeMenu()
		{
			...
			this.MenuItems.Add(new MetroWindowAndControlsViewModel(PackIconModernKind.InterfaceTextbox, "TextBox", "TextBoxのサンプル", "TextBoxPanel"));
			this.MenuItems.Add(new MetroWindowAndControlsViewModel(PackIconMaterialKind.FormTextbox, "MetroTextBox", "MetroTextBoxのサンプル", "MetroTextBoxPanel"));
